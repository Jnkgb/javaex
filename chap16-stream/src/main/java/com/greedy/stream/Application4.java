...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        List<String> highRatedActionMovies = movies.stream()
                .filter(mv->mv.getRating()>=8&&mv.getGenre().equals("액션"))
                .map(Movie::getTitle)
        ...
        Map<String, String> topRatedMoviesByGenre = movies.stream()
                .collect(Collectors.groupingBy(mv->mv.getGenre(),Collectors.maxBy(Comparator.comparingDouble(mv->mv.getRating()))) )
